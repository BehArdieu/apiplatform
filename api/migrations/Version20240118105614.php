 ...
 */
final class Version20240118105614 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE author (id INT NOT NULL, name VARCHAR(255) NOT NULL, birthday DATE NOT NULL, PRIMARY KEY(id))');
